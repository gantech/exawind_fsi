...
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
        400   TMax            - Total run time (s)
TIME_STEP     DT              - Recommended module time step (s)
...
"../../5MW_Baseline/NRELOffshrBsline5MW_InflowWind.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
OUTPUT_TIMESTEP   DT_Out          - Time step for tabular output (s) (or "default")
